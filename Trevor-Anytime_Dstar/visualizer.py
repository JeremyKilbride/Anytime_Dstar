...
if __name__ == "__main__":
    ...
    ax.imshow(costmap, extent=[0.5, x_size+0.5, 0.5, y_size+0.5], origin='lower')
    ax.set_xlim(0.5, x_size + 0.5)
    ax.set_ylim(0.5, y_size + 0.5)
    
    line1, = ax.plot([], [], lw=1, marker='o',markersize=1.5, color='b', label='robot')
    line2, = ax.plot([], [], lw=2, marker='o', markersize=1.5,color='r', label='target')
